...
//
// If the series has no prefix length,
...
// this item is simply incremented by the given increment value, positive or negative.
//
...
// For instance, an increment of count - 1 is the last value from the iterator,
// an increment of count - 2 is the second last value, and so on.
//
