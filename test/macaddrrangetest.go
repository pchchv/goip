...
func (t macAddressRangeTester) run() {
	...
	t.testMatches(false, "*-abcdef|fffffe", "0|ffffff-abcdef|fffffe") // inet.goip.IncompatibleAddressException: *-abcdef|fffffe, IP Address error: range of joined segments cannot be divided into individual ranges
	...
	t.testInsertAndAppend("*:*:*:*:*:*:*:*", "*:*:*:*:*:*:*:*", []goip.BitCount{0, 0, 0, 0, 0, 0, 0, 0, 0})
	t.testInsertAndAppend("a:b:c:d:e:f:aa:bb", "*:*:*:*:*:*:*:*", []goip.BitCount{0, 8, 16, 24, 32, 40, 48, 56, 64})
	t.testInsertAndAppendPrefs("*:*:*:*:*:*:*:*", "1:2:3:4:5:6:7:8", []goip.PrefixLen{nil, p0, p0, p0, p0, p0, p0, p0, p0})

	t.testInsertAndAppend("a:b:c:d:*:*:*:*", "1:2:3:4:*:*:*:*", []goip.BitCount{32, 32, 32, 32, 32, 32, 32, 32, 32})
	t.testInsertAndAppend("a:b:c:d:e:f:aa:bb", "1:2:3:4:*:*:*:*", []goip.BitCount{32, 32, 32, 32, 32, 40, 48, 56, 64})
	t.testInsertAndAppendPrefs("a:b:c:0-1:*:*:*:*", "1:2:3:4:5:6:7:8", []goip.PrefixLen{pnil, pnil, pnil, pnil, p31, p31, p31, p31, p31})
	t.testInsertAndAppendPrefs("a:b:c:d:*:*:*:*", "1:2:3:4:5:6:7:8", []goip.PrefixLen{pnil, pnil, pnil, pnil, p32, p32, p32, p32, p32})
	t.testInsertAndAppendPrefs("a:b:c:d:0-7f:*:*:*", "1:2:3:4:5:6:7:8", []goip.PrefixLen{pnil, pnil, pnil, pnil, pnil, p33, p33, p33, p33})

	t.testInsertAndAppend("a:b:*:*:*:*:*:*", "1:2:3:4:*:*:*:*", []goip.BitCount{32, 32, 16, 16, 16, 16, 16, 16, 16})
	t.testInsertAndAppend("a:b:c:d:*:*:*:*", "1:2:*:*:*:*:*:*", []goip.BitCount{16, 16, 16, 24, 32, 32, 32, 32, 32})
	t.testInsertAndAppendPrefs("*:*:*:*:*:*:*:*", "1:2:3:4:*:*:*:*", []goip.PrefixLen{p32, p0, p0, p0, p0, p0, p0, p0, p0})
	t.testInsertAndAppendPrefs("a:b:c:d:*:*:*:*", "1:2:3:4:5:6:7:8", []goip.PrefixLen{pnil, pnil, pnil, pnil, p32, p32, p32, p32, p32})
	t.testInsertAndAppendPrefs("a:b:c:d:e:f:aa:bb", "1:2:3:4:*:*:*:*", []goip.PrefixLen{p32, p32, p32, p32, p32, p40, p48, p56, pnil})
...
func (t macAddressRangeTester) testToOUIPrefixed(addrString string) {
	...
	v := w.GetAddress()
	suffixSeg := goip.NewMACRangeSegment(0, 0xff)
	suffixSegs := make([]*goip.MACAddressSegment, v.GetSegmentCount())
	v.CopySubSegments(0, 3, suffixSegs)
	for i := 3; i < len(suffixSegs); i++ {
		suffixSegs[i] = suffixSeg
	}
	suffix := goip.NewMACSection(suffixSegs)
	suffixed, err := goip.NewMACAddress(suffix)
	if err != nil {
...
func (t macAddressRangeTester) testOUIPrefixed(original, expected string, expectedPref goip.BitCount) {
...
func (t macAddressRangeTester) testEquivalentPrefix(host string, prefix goip.BitCount) {
	t.testEquivalentMinPrefix(host, cacheTestBits(prefix), prefix)
}

func (t macAddressRangeTester) testEquivalentMinPrefix(host string, equivPrefix goip.PrefixLen, minPrefix goip.BitCount) {
...
func bitCountToString(i goip.BitCount) string {
...
func (t macAddressRangeTester) testMACCountRedirect(w *goip.MACAddressString, number uint64) {
...
func (t macAddressRangeTester) testMACPrefixCountImpl(w *goip.MACAddressString, number uint64) {
	t.testPrefixCountImpl(w.Wrap(), number)
}

func (t macAddressRangeTester) testPrefixBlock(prefixedAddressStr string, expectedPref goip.BitCount) {
	...
	hostSeg := int((prefixedAddress.GetPrefixLen().Len() + (goip.MACBitsPerSegment - 1)) / goip.MACBitsPerSegment)
...
func enlargeMACSubnet(addr *goip.MACAddress /*boolean nextSegment  false , int bitsPerSegment, /* boolean skipBitCountPrefix false */) *goip.MACAddress {
...
func getMACLabel(addressString *goip.MACAddressString) string {
