...
func (t ipAddressAllTester) run() {
	...
	t.testMatches(true, goip.AlternativeRangeSeparatorStr+"0000000000=l?k|EPzi+", "00000000000000000000"+goip.AlternativeRangeSeparatorStr+"0000000000=l?k|EPzi+")
	t.testMatches(true, "00000000000000000000"+goip.AlternativeRangeSeparatorStr, "00000000000000000000"+goip.AlternativeRangeSeparatorStr+"=r54lj&NUUO~Hi%c2ym0")
	t.testMatches(true, "oBky9Vh_d)e!eUd#8280"+goip.AlternativeRangeSeparatorStr, "oBky9Vh_d)e!eUd#8280"+goip.AlternativeRangeSeparatorStr+"=r54lj&NUUO~Hi%c2ym0")
	...
	t.testMatches(true, "=r54lj&NUUO~Hi%c2yl0"+goip.AlternativeRangeSeparatorStr+"=r54lj&NUUO~Hi%c2ym0", "ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffaa-ffff")
	...
	t.ipv6test(true, "00|M>t|ttwH6V6EEzblZ"+goip.AlternativeRangeSeparatorStr+"00|M>t|ttwH6V6EEzkrZ")
	t.ipv6test(true, "00|M>t|ttwH6V6EEzkrZ"+goip.AlternativeRangeSeparatorStr+"00|M>t|ttwH6V6EEzblZ")
	t.ipv6test(false, "00|M>t|ttwH6V6EEzkr"+goip.AlternativeRangeSeparatorStr+"00|M>t|ttwH6V6EEzblZ")
	t.ipv6test(false, "00|M>t|ttwH6V6EEzkrZ"+goip.AlternativeRangeSeparatorStr+"0|M>t|ttwH6V6EEzblZ")
	t.ipv6test(false, "00|M>t|ttwH6V6EEzkrZx"+goip.AlternativeRangeSeparatorStr+"00|M>t|ttwH6V6EEzblZ")
	t.ipv6test(false, "00|M>t|ttwH6V6EEzkrZ"+goip.AlternativeRangeSeparatorStr+"x00|M>t|ttwH6V6EEzblZ")
	...
	t.ipv6test(true, "=q{+M|w0(OeO5^F85=Cb"+goip.IPv6AlternativeZoneSeparatorStr+"eth0") // ok
	t.ipv6test(false, "=q{+M|w0(OeO5^F85=C"+goip.IPv6AlternativeZoneSeparatorStr+"eth0") // too soon
...
func (t ipAddressAllTester) testBackAndForthIPv4(addrStr string) {
	...
	addr := goip.NewIPAddressString(addrStr).GetAddress()
	value := addr.GetValue()
	...
	andAgain, _ := goip.NewIPAddressFromNetIP(bigIntBytes)
	...
	// byte[] and back
	bytes := addr.Bytes()
	backAgain, _ := goip.NewIPAddressFromNetIP(bytes)
	...
	backAgainv4 := goip.NewIPv4AddressFromUint32(val)
...
func (t ipAddressAllTester) testBackAndForthIPv6(addrStr string) {
	...
	backAgainv6, err := goip.NewIPv6AddressFromInt(value)
	if err != nil {
...
func (t ipAddressAllTester) testMaskedRange(value, upperValue, maskValue uint64, expectedIsSequential bool, expectedLower, expectedUpper uint64) {
	masker := goip.MaskRange(value, upperValue, maskValue, math.MaxUint64)
