...
var (
	ipv4Trie  = constructIPv4Trie()
	ipv6Trie  = constructIPv6Trie()
	ipv4Prefs = []string{
...
func BenchmarkIPv4ElementContains(b *testing.B) {
	benchIPv4AddressContains(b, goip.NewIPAddressString("52.95.110.1").GetAddress().ToIPv4())
}

func BenchmarkIPv6ElementContains(b *testing.B) {
	benchIPv6AddressContains(b, goip.NewIPAddressString("2620:107:300f::36b7:ff81").GetAddress().ToIPv6())
}

func BenchmarkIPv4ElementNotContains(b *testing.B) {
	benchIPv4AddressContains(b, goip.NewIPAddressString("123.123.123.123").GetAddress().ToIPv4())
}

func BenchmarkIPv6ElementNotContains(b *testing.B) {
	benchIPv6AddressContains(b, goip.NewIPAddressString("2620::ffff").GetAddress().ToIPv6())
}

func benchIPv4AddressContains(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6AddressContains(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4LongestPrefixMatch(b *testing.B) {
	benchIPv4LongestPrefixMatch(b, goip.NewIPAddressString("52.95.110.1").GetAddress().ToIPv4())
}

func BenchmarkIPv6LongestPrefixMatch(b *testing.B) {
	benchIPv6LongestPrefixMatch(b, goip.NewIPAddressString("2620:107:300f::36b7:ff81").GetAddress().ToIPv6())
}

func BenchmarkIPv4LongestPrefixNoMatch(b *testing.B) {
	benchIPv4LongestPrefixMatch(b, goip.NewIPAddressString("123.123.123.123").GetAddress().ToIPv4())
}

func BenchmarkIPv6LongestPrefixNoMatch(b *testing.B) {
	benchIPv6LongestPrefixMatch(b, goip.NewIPAddressString("2620::ffff").GetAddress().ToIPv6())
}

func benchIPv4LongestPrefixMatch(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6LongestPrefixMatch(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4ShortestPrefixMatch(b *testing.B) {
	benchIPv4ShortestPrefixMatch(b, goip.NewIPAddressString("52.95.110.1").GetAddress().ToIPv4())
}

func BenchmarkIPv6ShortestPrefixMatch(b *testing.B) {
	benchIPv6ShortestPrefixMatch(b, goip.NewIPAddressString("2620:107:300f::36b7:ff81").GetAddress().ToIPv6())
}

func BenchmarkIPv4ShortestPrefixNoMatch(b *testing.B) {
	benchIPv4ShortestPrefixMatch(b, goip.NewIPAddressString("123.123.123.123").GetAddress().ToIPv4())
}

func BenchmarkIPv6ShortestPrefixNoMatch(b *testing.B) {
	benchIPv6ShortestPrefixMatch(b, goip.NewIPAddressString("2620::ffff").GetAddress().ToIPv6())
}

func benchIPv4ShortestPrefixMatch(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6ShortestPrefixMatch(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4ElementsContaining(b *testing.B) {
	benchIPv4ElementsContaining(b, goip.NewIPAddressString("52.95.110.1").GetAddress().ToIPv4())
}

func BenchmarkIPv6ElementsContaining(b *testing.B) {
	benchIPv6ElementsContaining(b, goip.NewIPAddressString("2620:107:300f::36b7:ff81").GetAddress().ToIPv6())
}

func benchIPv4ElementsContaining(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6ElementsContaining(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4ElementsContainedBy(b *testing.B) {
	benchIPv4ElementsContainedBy(b, goip.NewIPAddressString("52.95.104.0/21").GetAddress().ToIPv4())
}

func BenchmarkIPv6ElementsContainedBy(b *testing.B) {
	benchIPv6ElementsContainedBy(b, goip.NewIPAddressString("2a01:578:3::/80").GetAddress().ToIPv6())
}

func benchIPv4ElementsContainedBy(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6ElementsContainedBy(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4Contains(b *testing.B) {
	benchIPv4Contains(b, goip.NewIPAddressString("52.95.104.0/22").GetAddress().ToIPv4())
}

func BenchmarkIPv6Contains(b *testing.B) {
	benchIPv6Contains(b, goip.NewIPAddressString("2a01:578:3::36e4:1000/122").GetAddress().ToIPv6())
}

func BenchmarkIPv4NotContains(b *testing.B) {
	benchIPv4Contains(b, goip.NewIPAddressString("52.95.112.0/22").GetAddress().ToIPv4())
}

func BenchmarkIPv6NotContains(b *testing.B) {
	benchIPv6Contains(b, goip.NewIPAddressString("2a01:578:3::36e4:1040/122").GetAddress().ToIPv6())
}

func benchIPv4Contains(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6Contains(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4AddAndRemove(b *testing.B) {
	benchIPv4AddAndRemove(b, goip.NewIPAddressString("52.95.98.0/23").GetAddress().ToIPv4())
}

func BenchmarkIPv6AddAndRemove(b *testing.B) {
	benchIPv6AddAndRemove(b, goip.NewIPAddressString("2a01:578:3::b022:9fe0/123").GetAddress().ToIPv6())
}

func benchIPv4AddAndRemove(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6AddAndRemove(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4Floor(b *testing.B) {
	benchIPv4Floor(b, goip.NewIPAddressString("52.95.112.0/22").GetAddress().ToIPv4())
}

func BenchmarkIPv6Floor(b *testing.B) {
	benchIPv6Floor(b, goip.NewIPAddressString("2a01:578:3::36e4:1040/122").GetAddress().ToIPv6())
}

func benchIPv4Floor(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6Floor(b *testing.B, addr *goip.IPv6Address) {
...
func BenchmarkIPv4Ceiling(b *testing.B) {
	benchIPv4Ceiling(b, goip.NewIPAddressString("52.95.112.0/22").GetAddress().ToIPv4())
}

func BenchmarkIPv6Ceiling(b *testing.B) {
	benchIPv6Ceiling(b, goip.NewIPAddressString("2a01:578:3::36e4:1040/122").GetAddress().ToIPv6())
}

func benchIPv4Ceiling(b *testing.B, addr *goip.IPv4Address) {
...
func benchIPv6Ceiling(b *testing.B, addr *goip.IPv6Address) {
...
func constructIPv4Trie() *goip.IPv4AddressTrie {
	trie := &goip.Trie[*goip.IPv4Address]{}
	for _, addrStr := range ipv4Prefs {
		addr, err := goip.NewIPAddressString(addrStr).ToAddress()
		if err != nil {
...
func constructIPv6Trie() *goip.IPv6AddressTrie {
	trie := &goip.Trie[*goip.IPv6Address]{}
