...
func (t hostRangeTester) testHostAndAddress(h *goip.HostName, hostLabelCount, addressLabelCount int, isValidHost, isValidAddress bool, normalizedHostString, normalizedAddressString string) {
...
func (t hostRangeTester) testMasked(masked, mask string, prefixLength goip.PrefixLen, result string) {
